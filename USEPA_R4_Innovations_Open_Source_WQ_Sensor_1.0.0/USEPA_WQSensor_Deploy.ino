 ...
 *  Edited 29 Jan 2018 by Ray McClellan (Earth First Monitoring Group) - Included dual temp readings to work around temp probe error upon wakeup from sleep
 * ******************************************************************************************************************************************************************************/
/*##############################################################################################################################################################################
 * ############################################################################################################################################################################*/
...
void logmode(){
  ...
  wdt_reset();    // Reset watchdog timer  
                                         ...
                                         // Next 4 lines duplicated from above to get around -1023 data error - This edit was made by Ray McClellan from Earth First Monitoring Group
  Wire.beginTransmission(rtdaddress);    // Call I2C address for temperature circuit
  Wire.write("R");                       // Request a 2nd measurement from the temperature probe
  Wire.endTransmission();                // End the I2C data transmission 
  delay(1200);                           // Wait required time for circuit to process request
